    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link mx-auto">
          ...
          <span class="brand-text font-weight-light mx-auto">ECOM</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              ...
              @auth
              <div class="image">
                <img src="{{auth()->user()->avatar == 'noavatar' ? asset('noavatar.png') : auth()->user()->avatar }}" class="img-circle elevation-2" alt="User Image">
              </div>
              <div class="info">
      ...
      <div id="app" class="content-wrapper" style="min-height: 1592.4px;">
        @yield('content')
      </div>
      <!-- /.content-wrapper -->
